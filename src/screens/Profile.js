    ...
    render() {
        ...
        return (
            <LinearGradient colors={['#EE4B60', '#EF5090']}   style={styles.container}>
                <StatusBar backgroundColor="#EE4B60" barStyle="light-content" hidden={false}/>
                ...
                <View style={styles.body}>
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View style={{margin:20, flex:1, justifyContent:'flex-end'}}>
                            <TouchableOpacity style={{ backgroundColor:'#FFF', borderRadius:5, width:'30%', alignItems:'center', alignSelf:'flex-end'}} onPress={() => this.toggleEdit(!this.state.edit)}>
                    ...
                    <View style={{flexDirection:'row', alignItems:'center'}}>
                        ...
                        <TextInput
                            style={{color:'#FFF', fontSize:16}}
                            value={this.state.tempAvatar}
                            onChangeText={this.handleChange('tempAvatar')}
                        />
